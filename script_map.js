...
/*    if (window.innerHeight > sidebar_limit) {
    ...
    ui_side_svg.attr('height', height - bottombar_height)
    sidebar_height = ui_side_svg.attr('height')
    ...
    console.log(ui_side_svg.attr('height'))
};
...
slider_background = g_slider.append("rect")
    ...
    .attr("rx", 10)
    .attr("ry", 10)
    .attr("fill", "rgba(207,218,228,0.93)")
