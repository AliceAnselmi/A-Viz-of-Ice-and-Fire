map_img = "assets/map_clean.jpg"
slider_bg_img = "assets/slider_bg.png"
range_button_high_img = "assets/range_button_high2.png"
range_button_low_img = "assets/range_button_low2.png"
...
const bottombar_width = 1000;
const bottombar_height = 100;
const sidebar_width = 200;
var sidebar_height = height-bottombar_height;
const sidebar_limit = 500;
var Ytranslation_rescale = 0;

var slider_length = bottombar_width*0.4
const emblem_size = 8 //Determines the size of the emblems
...
/*    window.onresize = function(e) {
        //MAYBE WE NEED TO WORK WITH WIDTH AND HEIGHT ALL THE TIME
        width = window.innerWidth;
        height = window.innerHeight;
        viewport_width = parseInt(map_svg.style("width"))
        viewport_height = parseInt(map_svg.style("height"))
...
g_slider.append("rect")
    ...
    .attr("rx", 10)
    .attr("ry", 10)
    .attr("fill", "rgba(162,162,162,0.07)")
...
/*slider_infos.append("svg:image")
    ...
    .attr("x", (bottombar_width) / 2 - this.width / 2)
    .style("width", "40%")
    .style("height", "auto")*/
...
const slider = g_slider.append("g")
    ...
    .attr("transform", "translate(" + (bottombar_width/3)  + "," + bottombar_height/2 + ")")
...
var selRange = slider.append("line")
    ...
    .style("opacity", 0.6)
    .style("stroke-width", bottombar_height / 8 + "px")
...
view_selector.attr("x", -bottombar_width / 3.4)
    .attr("y", -bottombar_height/3)

var slider_selector_text = slider.append("text")
    .attr("x", view_selector.attr("x"))
    .attr("y", 0)
    //.attr("font-size", "25px")
    .attr("font-size", (bottombar_height/4 + "px"))
    .attr("cursor", "pointer")
...
function updateView() {
    ...
    if (currview == 0) {
        ...
        slider_image.attr("transform", "translate(0,-5)")
    ...
    handle.attr("x", d => x_slider(sliderVals[d]) - 10)
...
var filter_button = g_filter.append("svg:image")
    ...
    .attr("y", 20)
//NEED TO MAKE EXCEPTIONS FOR THIS TO WORK. PROBABLY NEVERMIND
/*    .attr("cursor", "pointer")
    .on("mouseover", function (d) {
            ui_side_svg
...
filters.append("pattern")
    ...
    .append("svg:image")
    .attr("xlink:href", (d) => {
        return "assets/emblems/House_" + d + ".svg"
    })
    .attr("width", "30%")
    .attr("x", 0)
    .attr("y", 0)
...
function select_emblem(emblem, data) {
    ...
    node = emblem.selectAll(".popup")
        ...
        .attr("xlink:href", (d) => {
            ...
            //var allegiance = d.Allegiances
            return "assets/emblems/House_" + allegiance + ".svg"
        })
